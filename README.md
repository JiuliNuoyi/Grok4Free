...
> **本工具仅供技术学习与安全研究使用。**
> 
> - ✅ 允许用于：个人学习、技术研究、安全测试（需获授权）
> - ❌ **禁止用于**：商业盈利、批量倒卖账号、恶意攻击、任何违法用途
> - ⚖️ **法律责任**：使用者须自行承担所有风险，作者不对任何直接或间接损失负责
> - 📜 **合规义务**：使用者必须遵守目标平台服务条款及当地法律法规
> 
> **使用本项目即表示您已阅读、理解并同意遵守以上声明。**
...
- **v0.1.1 (2026-07-29)**
  - ✅ Cookie 弹窗自动处理优化：轮询等待 15s，延迟出现也能捕获
  - ✅ 查看账号记录功能增强：跨平台支持更好
  - 🐛 修复语法错误导致无法启动的问题

- **v0.1.0 (2026-07-28)**
  - 🚀 初始版本，完成从 grok-register 项目独立重构
  - 🔐 三重邮箱支持：MoEmail / 微软自有邮箱 / 子邮箱
  - 🛡️ Turnstile 拟人化点击兜底
  - ⚡ 多进程并发注册（1-5 并发）
  - 🖥️ GUI + CLI 双模式
